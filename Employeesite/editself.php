    ...
    ?>
        ...
        <main id="blur_bg">
            ...
            <aside>
                ...
                <button onclick="showpopup()" style="margin-top:10px;padding: 3px; border-radius:10px;">Edit Profile</button>
                <br>

                <button id="goBackButton" style="margin-top:10px;padding: 3px; border-radius:10px;">Go Back</button>
                <script>
