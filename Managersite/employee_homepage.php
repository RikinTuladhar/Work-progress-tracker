          ...
          <form action="emp_action/employeeadd.php" name="emp_validate" method="post" enctype="multipart/form-data">
            <div class="row">
              <div class="margin-content">
                ...
                <br><input type="text" id="Name" name="Name" class="large-input" placeholder="Name" class="large-input">
              </div><br>
              <div class="margin-content">
                <br><label class="large-input" for="Email"> Email</label><br>
                <br><input type="Email" id="Email" name="Email" placeholder="Email" class="large-input">
              </div><br>
            </div>
            ...
            <div class="row">
              <div class="margin-content">
                ...
                <br><input type="text" id="Last-Name" name="Last-Name" class="large-input" placeholder="Last-Name" class="large-input">
              </div><br>
              <div class="margin-content">
                <br><label class="large-input" for="Password"> Password</label><br>
                <br><input type="password" id="Password" name="Password" placeholder="Password" class="large-input">
              </div><br>
            </div>
            ...
            <div class="row">
              <div class="margin-content">
                ...
                <br><input type="text" id="Phone" name="Phone" class="large-input" placeholder="Phone">
              </div><br>
              <div class="margin-content">
                <br><label class="large-input  avatar" for="Avatar" style="margin-left: 100px;">Avatar</label><br>
                <br><input type="file" id="image" name="image" accept=".jpg, .jpeg ,.png" style="margin-left: 100px;">
              </div><br>
            </div>
