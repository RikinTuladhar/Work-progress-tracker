          ...
          <form action="task_action/taskadd.php" method="post" enctype="multipart/form-data">
            <div class="row">
              <div class="margin-content">
                ...
                <br><input type="text" class="large-input" id="Name" name="Name" placeholder="Task Name" required>
              </div><br>
              <div class="margin-content">
          ...
          <option value="Completed">Completed</option> -->
            ...
            <div class="row">
              <div class="margin-content">
                ...
                <br><input type="date" id="Start-Date" name="Start-Date" class="large-input" placeholder="" class="large-input" required>
              </div><br>
              <div class="margin-content">
                <br><label class="large-input" for="End-Date">End Date</label><br>
                <br><input type="date" id="End-Date" name="End-Date" placeholder="" class="large-input" required>
              </div><br>
            </div>
