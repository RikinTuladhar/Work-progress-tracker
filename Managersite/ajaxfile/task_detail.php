...
<body>
  ...
  $sql = "SELECT * FROM tasks INNER JOIN employee on tasks.e_id = employee.eid  INNER JOIN manager on tasks.m_id = manager.m_id  where task_id = $task_id";
  ...
  ?>
  <header>
    <h1 style="text-align: center;">About Task </h1>
  </header>
  <div id="main">
    <nav>
    ...
    <article>
      ...
      <div class="flex-box">
        ...
        <h3>Task Given By: <span><?php echo $row['m_name'] ?></span></h3>
      </div>
    </article>
    <aside style="text-align: center;">
      ...
      <h3>Started Task date: <span style="color: #1A5D1A">
          <?php
          if ($row['started_task'] === '0000-00-00') {
            echo 'Not Started';
          } else {
            echo $row['started_task'];
          }
          ?>
        </span></h3>

      <h3>Finished Task date: <span style="color: #D71313;"><?php
                                                            if ($row['finished_task'] === '0000-00-00') {
                                                              echo "Not Finished";
                                                            } else {
