  ...
  ?>
    ...
    <div class="container">
      <div id="total">
        ...
        <div class="total_container" id="total_employee">
          <h3>Total Employee <?php echo $result_employee; ?></h3>
        </div>
        <div class="total_container" id="total_employee">
          <h3>Total Pending tasks <?php echo $result_pending; ?></h3>
        </div>
        <div class="total_container" id="total_employee">
          <h3>Total On-going tasks <?php echo $result_on_going; ?></h3>
        </div>
        <div class="total_container" id="total_employee">
          <h3>Total Completed tasks <?php echo $result_completed; ?></h3>
        </div>
